...
export class UsersService {
  ...
  async updateProfile(id: string, requesterId: string, dto: UpdateProfileDto): Promise<UserEntity> {
    if (id !== requesterId) {
  ...
  async uploadAvatar(id: string, requesterId: string, buffer: Buffer, mimeType: string): Promise<{ avatarUrl: string }> {
    if (id !== requesterId) {
